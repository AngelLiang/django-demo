...
class Hook(BaseModel):
    ...
    workflow = models.ForeignKey(Workflow, verbose_name=_("Workflow"), related_name='%(app_label)s_%(class)s_hooks', on_delete=models.CASCADE)
    ...
    is_raise_exception = models.BooleanField(_('是否抛出异常'), default=False)
