...
from ..forms.testapp import TestappForm
from ..resources.testapp import TestappResource


class TestappAdmin(ImportExportMixin, admin.ModelAdmin):
    search_fields = ('name',)
    ...
    form = TestappForm
    resource_class = TestappResource
    formats = (XLSX,)
